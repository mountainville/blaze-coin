...
info0.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo0");
});
info1.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo1");
});
info2.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo2");
});
info3.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo3");
});
info4.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo4");
});
info5.addEventListener("mouseenter", () => {
  clickCheck("rmpExtraInfo5");
});

info0.addEventListener("mouseleave", () => {
  clickCheck("rmpExtraInfo0");
});
info1.addEventListener("mouseleave", () => {
  clickCheck("rmpExtraInfo1");
});
info2.addEventListener("mouseleave", () => {
  clickCheck("rmpExtraInfo2");
});
...
const team = document.querySelectorAll(".rmp-card");
team.forEach((entry) =>
